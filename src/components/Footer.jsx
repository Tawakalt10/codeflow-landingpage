...
const footerLinks = {
  ...
  Legal: ["Privacy", "Terms", "Cookie Policy", "Licences", "Compliance"],
};
  ...
  return (
    <footer className="border-t border-slate-800 bg-slate-950/50 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8 lg:gap-12 mt-8 sm:mb-12">
          <div className="col-span-1 sm:col-span-3 lg:col-span-2 text-center sm:text-left">
            <div className="flex items-center justify-center sm:justify-start space-x-2 mb-3 sm:mb-4">
              <div className="rounded-lg">
                {/* <img src=" " alt="CodeFlow Logo" className="w-6 h-6 sm:w-8 sm:h-8" /> */}
              </div>
