...
export default function Hero () {
    ...
    <div className="max-w-7xl   mt-7 mx-auto text-center relative w-full">
      ...
      <div>
         ...
         <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8 sm:mb-12 animat-in slide-in-from bottom duration-700 delay-300"> 
          <button className="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-linear-to-b from-blue-600 to-blue-400 rounded-lg font-semibold  text-sm sm:text-base transition-all duration-300  hover:scale-102 flex items-center justify-center space-x-2">
           ...
           <button className ="group w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4  bg-white/5 backdrop-blur-sm  boder border-white/10 rounded-lg font-semibold  text-sm sm:text-base transition-all duration-300  hover:bg-white/10 flex items-center justify-center space-x-2">
      ...
      <div className="relative order-2 w-full">
           ...
           <div className="bg-gradient-to-br from-gray-900/20 to gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-[350px] sm:h-[350px] lg:h-[450px] border border-white/5">
            {/*  IDE HEADER */}
  ...
  {String(codeExamples?.[activeTab] ?? "")}
      ...
      {/*Floating cards  */}
       ...
       transform translate-x-8 translate-y-8 w-72 ${currentFloatingcard.bgColor} backdrop-blur-xl rounded-lg p-4 order border border-white/20 shadow-2xl`}>
